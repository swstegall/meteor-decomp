// [STAMPED] from FUN_004ef330.cpp by tools/stamp_clusters.py
//           sibling at orig RVA 0x004a3ba0 (VA 0x008a3ba0)
//           same byte-shape cluster — see cluster_shapes.py output
// [SEED] from FUN_004ec8a0.cpp by tools/seed_templates.py
//        target VA 0x008a3ba0 (RVA 0x000ef330)
...
//
// FUNCTION: ffxivgame 0x008a3ba0 — empty `__thiscall` 5-arg method (RET 0x14).
