// [STAMPED] from FUN_00408290.cpp by tools/stamp_clusters.py
//           sibling at orig RVA 0x002021a0 (VA 0x006021a0)
//           same byte-shape cluster — see cluster_shapes.py output
// [SEED] from FUN_004087e0.cpp by tools/seed_templates.py
//        target VA 0x006021a0 (RVA 0x00008290)
...
//
// FUNCTION: ffxivgame 0x006021a0 — `this`-cached call-and-return-self
