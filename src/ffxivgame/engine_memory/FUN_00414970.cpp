...
//
// FUNCTION: ffxivgame 0x00014970 — multi-inheritance `this`-adjustor (SUB ECX, 0x4; JMP)
//
// Asm (8 bytes @ orig RVA 0x00014970):
//   83 e9 04    SUB ECX, 0x4   ; adjust `this` pointer by -4 (base sub-object offset)
//   e9 RR RR RR RR  JMP FUN_00414b00  ; tail-call the real implementation
//
...
extern "C" void FUN_00414970() { __builtin_unreachable(); }
#else
extern "C" __declspec(naked) void FUN_00414970() {
    __asm {
        sub ecx, 4
        jmp FUN_00414b00
    }
