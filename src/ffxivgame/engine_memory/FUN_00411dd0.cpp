...
//
// FUNCTION: ffxivgame 0x00011dd0 — multi-inheritance `this`-adjustor (SUB ECX, 0x8; JMP)
//
// Asm (8 bytes @ orig RVA 0x00011dd0):
//   83 e9 08           SUB ECX, 0x8       ; adjust `this` pointer by -8 (base sub-object offset)
//   e9 RR RR RR RR     JMP FUN_00412230   ; tail-call the real implementation
//
...
extern "C" void FUN_00411dd0() { __builtin_unreachable(); }
#else
extern "C" __declspec(naked) void FUN_00411dd0() {
    __asm {
        sub ecx, 8
        jmp FUN_00412230
    }
