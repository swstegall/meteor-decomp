...
//
// Ghidra pseudo-C indicated void return, but actual binary returns `this` in
// EAX — same pattern as IBlock's scalar deleting destructor (FUN_00410400).
...
//   E8 xx xx xx xx      CALL _free                            ; REL32 reloc
//   83 C4 04            ADD ESP, 4
//  no_delete:
