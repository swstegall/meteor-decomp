...
//
// FUNCTION: ffxivgame 0x0000f5d0 — __thiscall: double-deref vtable dispatch
//                                   (14 bytes)
//
// Asm (14 bytes @ orig RVA 0x0000f5d0):
...
//   8b 50 08    MOV EDX, dword ptr [EAX + 0x8]  ; EDX = vtable[2] (function pointer)
...
// field_0x4, fetches the function at vtable offset 0x8 (slot 2), adjusts ECX
// to the sub-object base (inner + 4), and tail-calls it. No frame, no saved
// registers.

extern "C" __declspec(naked) void FUN_0040f5d0() {
    __asm {
