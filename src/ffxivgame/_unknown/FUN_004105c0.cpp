...
//
// Iterates a doubly-linked list embedded in `this`. For each node it:
//   1. Calls vtable[1] on the node (__thiscall, returns some result object).
...
//      with args (&this->field_04, result->field_10).
