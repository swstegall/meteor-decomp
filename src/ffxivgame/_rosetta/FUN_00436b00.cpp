...
//
// FUNCTION: ffxivgame 0x00436b00 — formatted-message dispatch helper
//                                  (__cdecl, 180 B / 0xb4)
//
// Recovered behaviour (from asm/ffxivgame/00036b00_FUN_00436b00.s):
//
//   The function takes a wad of stack args, picks one of two format
//   strings depending on whether arg4 is non-zero, renders the result
//   into a 0x800-byte local buffer with _snprintf_s, then hands the
//   buffer + a code (6) to an indirect dispatch routine.
//
//   __cdecl void FUN_00436b00(unsigned a0, unsigned a1, unsigned a2,
//                             unsigned a3, unsigned a4, unsigned a5,
//                             unsigned a6, unsigned a7)
//   {
//       char buf[0x800];                              // /GS-guarded array
//       if (a4 != 0)
//           _snprintf_s(buf, 0x800, 0x7ff, FMT1 /*0xf65b20*/,
//                       a2, a3, a4, a0, a1);
//       else
//           _snprintf_s(buf, 0x800, 0x7ff, FMT2 /*0xf65b40*/,
//                       a2, a3, a0, a1);
...
//   +0x42   PUSH offset FMT1                   (.rdata 0x00f65b20)
//   +0x56   CALL rel32 → 0x009d4f9f            (_snprintf_s)
//   +0x69   PUSH offset FMT2                   (.rdata 0x00f65b40)
//   +0x7d   CALL rel32 → 0x009d4f9f            (_snprintf_s)
//   +0x8d   CALL [0x012651b4]                  (indirect dispatch)
//   +0xa0   MOV  [global], 0                   (DIR32)
//   +0xa9   CALL rel32 → 0x009d20f4            (__security_check_cookie)
//
// Reconstruction strategy — naked-asm byte passthrough (same idiom as the
// sibling FUN_00403f10): a `__declspec(naked)` body re-emits the orig 180
// bytes verbatim via MASM `_emit`. The .obj's `.text` ends up byte-
// identical to the orig slice; compare.py masks the reloc windows and
// reports GREEN.

extern "C" __declspec(naked) void FUN_00436b00() {
    __asm {
        ...
        _emit 0x74              // JZ +0x28 (else-branch @ 0x36b5f)
        _emit 0x28
        ...
        _emit 0x68              // PUSH offset FMT1 (0x00f65b20)   (reloc)
        _emit 0x20
        _emit 0x5b
        _emit 0xf6
        _emit 0x00
        ...
        _emit 0xc4
        _emit 0x24
        _emit 0xeb              // JMP +0x25 (tail @ 0x36b84)
        _emit 0x25
        ...
        _emit 0x56              // PUSH ESI  (a2)
        _emit 0x68              // PUSH offset FMT2 (0x00f65b40)   (reloc)
        _emit 0x40
        _emit 0x5b
        _emit 0xf6
        _emit 0x00
