...
//
// FUNCTION: ffxivgame 0x00409510 — lazy-init global accessor / setter
...
//     +0x08  PUSH imm32         0xe5499e          (SEH handler VA)
//     +0x1a  TEST [imm32], AL   0x01327af0        (guard byte)
//     +0x22  OR   [imm32], EAX  0x01327af0
//     +0x30  CALL rel32         → FUN_0040e500    (rel32 = 0x4fbb)
//     +0x35  MOV  [imm32], EAX  0x01327aec        (global value slot)
//     +0x42  MOV  [imm32], EAX  0x01327aec
//     +0x58  MOV  EAX, [imm32]  0x01327aec
//
...
extern "C" __declspec(naked) void FUN_00409510() {
    __asm {
        ...
        _emit 0x00
        _emit 0x00
        _emit 0x84                  // TEST byte ptr [0x01327af0], AL
        _emit 0x05
        _emit 0xf0
        _emit 0x7a
        _emit 0x32
        ...
        _emit 0x18
        _emit 0x09                  // OR  dword ptr [0x01327af0], EAX
        _emit 0x05
        _emit 0xf0
        _emit 0x7a
        _emit 0x32
        ...
        _emit 0x00
        _emit 0x00
        _emit 0xe8                  // CALL FUN_0040e500 (rel32 = 0x000004bb)
        _emit 0xbb
        _emit 0x4f
        _emit 0x00
        _emit 0x00
        _emit 0xa3                  // MOV [0x01327aec], EAX
        _emit 0xec
        _emit 0x7a
        _emit 0x32
        _emit 0x01
