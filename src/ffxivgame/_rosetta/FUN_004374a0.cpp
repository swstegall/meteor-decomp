...
//
// FUNCTION: ffxivgame 0x3374a0 — allocate-and-dispatch member fn (__thiscall, 79 B).
//
// Sibling of FUN_00433f50: reads a global manager pointer at 0x01328d90,
// indexes into its element table (`tbl->base[ tbl->index * 7 ]` — a 28-byte
// stride formed by `(index*8 - index)*4`), and asks that element to allocate
// an 8-byte object via FUN_00417ab0(this=element, size=8).
//
// On success the new object is given a vtable (0x00f64988) and stashes the
...
//
//   void __thiscall FUN_004374a0(int arg) {
...
//   +0x2a  MOV [EAX], offset 0xf64988 (dir32, vtable)
...
extern "C" __declspec(naked) void FUN_004374a0() {
    __asm {
        push    esi
        mov     esi, ecx
