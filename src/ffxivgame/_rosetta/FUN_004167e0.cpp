...
//
// FUNCTION: ffxivgame 0x000167e0 — MSVC scalar deleting destructor, vtable-set form (36 B)
//
...
//
// Asm (36 bytes @ orig RVA 0x000167e0):
//   56                    PUSH ESI
//   8b f1                 MOV ESI, ECX          ; this
//   c7 06 RR RR RR RR     MOV dword ptr [ESI], vtable_ptr   ; set vtable (reloc)
//   e8 RR RR RR RR        CALL FUN_00417490     ; real destructor (thiscall, ECX=ESI)
...
extern "C" void FUN_00417490();         // real destructor (__thiscall)
extern "C" void FUN_004162c0(void *);   // custom free (__cdecl, 1 arg)
extern "C" int g_vtable_167e0;          // vtable data at VA 0x00f57678

extern "C" __declspec(naked) void FUN_004167e0(unsigned int) {
    __asm {
        push esi
        mov esi, ecx
        mov dword ptr [esi], offset g_vtable_167e0
        call FUN_00417490
