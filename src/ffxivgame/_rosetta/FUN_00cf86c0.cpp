// [STAMPED] from FUN_004ec8a0.cpp by tools/stamp_clusters.py
//           sibling at orig RVA 0x008f86c0 (VA 0x00cf86c0)
...
//
// FUNCTION: ffxivgame 0x00cf86c0 — empty `__thiscall` 5-arg method (RET 0x14).
