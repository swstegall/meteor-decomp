...
//
// FUNCTION: ffxivgame 0x0001ab70 — MSVC scalar deleting destructor,
...
// stack arg (RET 4).
//
// Asm (36 bytes @ orig RVA 0x0001ab70):
//   56                    PUSH ESI
//   8b f1                 MOV ESI, ECX                ; this
//   c7 06 RR RR RR RR     MOV dword ptr [ESI], vtable ; set vtable (reloc)
//   e8 RR RR RR RR        CALL FUN_0041aa70            ; real dtor (__thiscall)
...
extern "C" void FUN_0041aa70();      // real destructor (__thiscall, no stack args)
extern "C" void FUN_0040df70();      // thiscall free, one stack arg (callee RET 4)
extern "C" int g_vtable_1ab70;       // vtable data at VA 0x00f58214

extern "C" __declspec(naked) void FUN_0041ab70(unsigned int) {
    __asm {
        push esi
        mov esi, ecx
        mov dword ptr [esi], offset g_vtable_1ab70
        call FUN_0041aa70
