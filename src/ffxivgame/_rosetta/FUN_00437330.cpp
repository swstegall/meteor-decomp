...
//
// FUNCTION: ffxivgame 0x37330 — allocate-and-dispatch member fn (__thiscall, 79 B).
//
...
//
// On success the new object is given a vtable (0x00f64968) and stashes the
...
//
//   void __thiscall FUN_00437330(int arg) {
...
extern "C" __declspec(naked) void FUN_00437330() {
    __asm {
        push    esi
        mov     esi, ecx
