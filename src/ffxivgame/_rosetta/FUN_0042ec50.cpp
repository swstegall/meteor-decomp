...
//
// FUNCTION: ffxivgame 0x0042ec50 — `__thiscall` row-vector × 4x4-matrix
//                                  SSE transform (346 B / 0x15a).
//
// Inspection (read from the disassembly at orig RVA 0x0002ec50):
//
//   __thiscall void transform(const Matrix4 *this /*ECX*/,
//                             Vec4 *out  /*[EBP+0x08]*/,
//                             const Vec4 *v /*[EBP+0x0c]*/);
//
//   Computes the classic SIMD broadcast-multiply-add:
//
//     out = v.x * this->row0 + v.y * this->row1
//         + v.z * this->row2 + v.w * this->row3
//
//   where `this` is a 16-float (4x4) matrix laid out row-major at
//   ECX[0x00..0x3c], `v` is a 4-float vector at [EBP+0xc], and the
//   result 4 floats land at [EBP+0x8].
//
...
//     XMM2 = load row3
//     XMM1 += XMM2 * shuffle(XMM0, 0xFF)   ; broadcast v.w
...
//   literal reference, so the 346 function bytes are position-
...
//   source-level intrinsics rewrite is brittle under /O2 — the
//   compiler readily folds the scratch loads into MOVUPS or reorders
//   the shuffles, shifting bytes. Because the function carries zero
...
//   future source-level promotion once the Matrix4/Vec4 types are
//   reconstructed.

extern "C" __declspec(naked) void FUN_0042ec50() {
    __asm {
        _emit 0x55                          // PUSH EBP
        ...
        _emit 0x28
        _emit 0xd8
        _emit 0x0f                          // SHUFPS XMM3,XMM0,0xaa  ; broadcast v.z
        _emit 0xc6
        _emit 0xd8
        _emit 0xaa
        _emit 0x0f                          // MULPS XMM2,XMM3
        ...
        _emit 0x58
        _emit 0xca
        _emit 0xf3                          // MOVSS XMM2,[ECX+0x30]
        _emit 0x0f
        _emit 0x10
        _emit 0x51
        _emit 0x30
        ...
        _emit 0x14
        _emit 0x24
        _emit 0xf3                          // MOVSS XMM2,[ECX+0x34]
        _emit 0x0f
        _emit 0x10
        _emit 0x51
        _emit 0x34
        ...
        _emit 0x24
        _emit 0x04
        _emit 0xf3                          // MOVSS XMM2,[ECX+0x38]
        _emit 0x0f
        _emit 0x10
        _emit 0x51
        _emit 0x38
        ...
        _emit 0x24
        _emit 0x08
        _emit 0xf3                          // MOVSS XMM2,[ECX+0x3c]
        _emit 0x0f
        _emit 0x10
        _emit 0x51
        _emit 0x3c
        ...
        _emit 0x24
        _emit 0x0c
        _emit 0x0f                          // MOVAPS XMM2,[ESP]   ; XMM2 = row3
        _emit 0x28
        _emit 0x14
        _emit 0x24
        _emit 0x0f                          // SHUFPS XMM0,XMM0,0xff  ; broadcast v.w
        _emit 0xc6
        _emit 0xc0
        _emit 0xff
