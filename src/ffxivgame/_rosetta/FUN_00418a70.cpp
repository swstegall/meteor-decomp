...
//
// FUNCTION: ffxivgame 0x00018a70 — unknown (__cdecl, 190 B / 0xbe)
//
...
//        zero [ESP], PUSH arg4, PUSH 9, PUSH ECX, PUSH EDX,
//        LEA ECX, [ESP+0x38], PUSH ECX
//   4. CALL 0x00418970   (sub-function, reloc at +0x67)
//   5. ADD ESP, 0x1c      (cdecl cleanup, 7 args × 4 = 28 bytes)
...
//   +0x03   scope_table ptr  (.rdata 0x00e5543b)
//   +0x11   __security_cookie load (.data 0x012ea8b0)
//   +0x67   CALL rel32 → 0x00418970 (sub-function)

extern "C" __declspec(naked) void FUN_00418a70() {
    __asm {
        // 00018a70 — SEH3 prolog
        _emit 0x6a  // PUSH -1
        _emit 0xff
