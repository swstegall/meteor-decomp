...
//
// FUNCTION: ffxivgame 0x000390d0 — `__thiscall` argument-forwarding thunk:
//                                   packs 4 dwords + 1 byte into a 0x14-byte
//                                   stack temp and forwards it (by pointer)
//                                   to a sub-object method at this+0x08
//                                   (60 B / 0x3c)
//
// Inspection (read from the disassembly at orig RVA 0x000390d0):
//
//   __thiscall void FUN_004390d0(this, int a0, int a1, int a2, int a3, char a4)
//     ECX        : this
...
//   then  PUSH &temp ; ADD ECX,0x08 ; CALL 0x004367b0   (the [ESP+0x14]
...
//   method on the sub-object at this+0x08 taking a single pointer arg.
//
...
//         this->sub_0x08.process(&p);          // FUN_004367b0
//     }
//
// Structurally identical to FUN_00438140 (this+0x10) and FUN_00438180
// (this+0x10); only the ADD ECX immediate (0x08 here vs. 0x10 there)
// and the CALL rel32 displacement differ.
//
...
//             rel32 = 0xffffd6aa  (target 0x004367b0, next insn 0x00439106)
//
// Reconstruction strategy — naked-asm byte passthrough:
//
//   Same approach as siblings FUN_00438140 / FUN_00438180: a
...
//   the orig slice; the rel32 CALL site is masked by tools/compare.py. GREEN.

extern "C" __declspec(naked) void FUN_004390d0() {
    __asm {
