...
//
// FUNCTION: ffxivgame 0x00046f20 — __thiscall buffer "is-greater" predicate
//                                  (45 bytes / 0x2D).
//
...
//       return r > 0;                         // XOR EDX / TEST / SETG DL
//   }
//
...
//     / SETG DL / MOV AL,DL` — signed `> 0` on memcmp's int return.
//
...
extern "C" __declspec(naked) void FUN_00446f20() {
    __asm {
