...
//
// FUNCTION: ffxivgame 0x00411310 — MSVC scalar deleting destructor with
//                                  trivial-body inlining (31 B form).
//
// __thiscall void *FUN_00411310(int flags)
//   ECX        : this
//   [ESP+0x4]  : flags  (bit 0 = "also call ::operator delete(this)")
//
// Asm shape (31 bytes, read from orig RVA 0x00011310):
//
//   00011310:  f6 44 24 04 01     test   byte ptr [esp+4], 1   ; flags & 1
//   00011315:  56                 push   esi
//   00011316:  8b f1              mov    esi, ecx              ; ESI = this
//   00011318:  c7 06 cc 6c f5 00  mov    dword ptr [esi], offset T_vftable
//                                                              ; inlined dtor:
//                                                              ; restore T's
//                                                              ; vftable @
//                                                              ; 0x00f56ccc
//   0001131e:  74 09              jz     no_delete             ; carries ZF
//                                                              ; from the
//                                                              ; pre-prologue
//                                                              ; TEST (none of
//                                                              ; the intervening
//                                                              ; PUSH/MOV's
//                                                              ; touch flags)
//   00011320:  56                 push   esi                   ; arg: this
//   00011321:  e8 f1 07 5c 00     call   operator_delete       ; rel32 →
//                                                              ; 0x009d1b17
//   00011326:  83 c4 04           add    esp, 4                ; pop arg
//   no_delete:
//   00011329:  8b c6              mov    eax, esi              ; return this
//   0001132b:  5e                 pop    esi
//   0001132c:  c2 04 00           ret    4                     ; __thiscall,
//                                                              ; 1 stack arg
//
...
// TEST's verdict.
//
// Same 31-byte form as FUN_00409580; differs only in the vftable address
// (0x00f56ccc here vs 0x00f552bc there) and the CALL displacement.
//
// Reloc-bearing sites in the orig 31 bytes:
//   +0x0a   MOV  imm32 → 0x00f56ccc   (DIR32, T's own vftable)
...
extern "C" __declspec(naked) void FUN_00411310() {
    __asm {
        ...
        _emit 0xf1
        _emit 0xc7              // MOV dword ptr [ESI], 0x00f56ccc
        _emit 0x06
        _emit 0xcc
        _emit 0x6c
        _emit 0xf5
