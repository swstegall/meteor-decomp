...
//
// FUNCTION: ffxivgame 0x0043b620 — conditional debug-log formatter
// (__cdecl void FUN_0043b620(arg1, arg2, arg3, arg4, arg5, arg6, arg7), 180 B / 0xb4)
//
// Behaviour (recovered from asm @ 0x0003b620):
//
//   Byte-for-byte structural twin of the already-matched sibling
//   FUN_0043bfc0 (@ 0x0003bfc0, 0x9a0 bytes away, same translation unit /
//   logging subsystem). Allocates a 2048-byte stack buffer (char buf[0x800]),
//   then selects one of two _snprintf_s-like format strings based on whether
//   the fifth argument (arg5) is non-zero:
//
//     if (arg5 != 0)
...
//   +0x42   PUSH offset fmt_with_col             (.rdata 0x00f66474)
//   +0x56   CALL rel32 → fn_009d4f9f            (snprintf-like, 0x009d4f9f)
//   +0x69   PUSH offset fmt_no_col              (.rdata 0x00f663ec)
...
extern "C" {
    ...
    extern char fmt_with_col[];   // VA 0x00f66474  (non-zero branch: includes col/line fields)
    extern char fmt_no_col[];     // VA 0x00f663ec  (zero branch: omits column field)
...
extern "C" __declspec(naked) void FUN_0043b620()
{
    __asm {
