...
//
// FUNCTION: ffxivgame 0x004063c0 — assertion/panic formatter + dispatch
//                                   (__cdecl, 166 bytes / 0xa6)
//
// __cdecl void FUN_004063c0(const char *expr, const char *msg,
...
//
// Behaviour (inspected from the orig 166 bytes at RVA 0x000063c0):
//
...
//   driving compare.py here, so the same approach the sibling
//   FUN_00403bd0 / FUN_00403eb0 took — a `__declspec(naked)` body
...
extern "C" __declspec(naked) void FUN_004063c0() {
    __asm {
        ...
        _emit 0x00
        _emit 0x00
        _emit 0x8b              // MOV EDX, dword ptr [ESP+0x810]  (line)
        _emit 0x94
        _emit 0x24
        _emit 0x10
        _emit 0x08
        ...
        _emit 0x8b              // MOV EAX, dword ptr [ESP+0x810]  (file via reload)
        _emit 0x84
        _emit 0x24
        _emit 0x10
        _emit 0x08
