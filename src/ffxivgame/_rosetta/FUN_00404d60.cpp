...
//
// FUNCTION: ffxivgame 0x00404d60 — `std::vector<T, A>::insert(pos, value)`
//                                  emplace-at-end fast path for a 28-byte
//                                  (0x1c) element type (165 B / 0xA5).
//
// __thiscall void FUN_00404d60(Vector *this, T *pos)
...
//                                 ;   passed by-value to FUN_00404570)
//   push ebx
//   push esi
...
//   call FUN_00404570             ; __cdecl emplace-at-slot helper
...
//   call FUN_00404ca0             ; __thiscall realloc-and-insert
//   pop  edi
//   pop  esi
//   pop  ebx
//   add  esp, 0x08
...
//     +0x66   CALL rel32   → FUN_00404570       (RVA 0x00404570)
//     +0x84   CALL rel32   → FUN_009d22b4       (RVA 0x009d22b4 —
//                                                _invalid_parameter_noinfo)
//     +0x97   CALL rel32   → FUN_00404ca0       (RVA 0x00404ca0)
//
...
//   controls — and the two callees (FUN_00404570, FUN_00404ca0) are
...
extern "C" __declspec(naked) void FUN_00404d60() {
    __asm {
        ...
        _emit 0x01
        _emit 0x57              // PUSH EDI
        _emit 0xe8              // CALL FUN_00404570 (rel32 → 0xfffff7a5)
        _emit 0xa5
        _emit 0xf7
        _emit 0xff
        _emit 0xff
        ...
        _emit 0x05
        _emit 0xe8              // CALL FUN_009d22b4 (rel32 → 0x005cd4cb)
        _emit 0xcb
        _emit 0xd4
        _emit 0x5c
        _emit 0x00
        ...
        _emit 0xce
        _emit 0xe8              // CALL FUN_00404ca0 (rel32 → 0xfffffea4)
        _emit 0xa4
        _emit 0xfe
        _emit 0xff
        _emit 0xff
