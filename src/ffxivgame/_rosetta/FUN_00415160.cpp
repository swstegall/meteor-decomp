...
//
// FUNCTION: ffxivgame 0x00015160 — assertion failure handler (third
//                                   duplicate of FUN_0040f2d0 /
//                                   FUN_0040f8e0; byte-identical
//                                   structure, different RVA)
//                                   (__cdecl, 166 B / 0xa6)
//
// void __cdecl FUN_00415160(const char *cond, const char *msg,
...
extern "C" __declspec(naked) void FUN_00415160() {
    __asm {
        ...
        call    _snprintf_s
        // Offset 0x48:  83 c4 24              ADD ESP, 0x24         (clean 9 args)
        add     esp, 0x24
    ...
    zero_branch:
        ...
        call    _snprintf_s
        // Offset 0x86:  83 c4 20              ADD ESP, 0x20         (clean 8 args)
        add     esp, 0x20
