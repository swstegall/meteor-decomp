...
//
// FUNCTION: ffxivgame 0x00421e10 — __thiscall container clear/teardown
//                                  (58 B / 0x3a)
//
// __thiscall void FUN_00421e10(this)
//   ECX : this
//
// Inspection (read from the orig bytes at RVA 0x00021e10, 58 bytes):
//
...
//   push eax                    ; arg1: &temp
//   mov  ecx, esi               ; this
//   call FUN_00421c70           ; this->helper(&temp, this, *_Myptr, this, _Myptr)
...
//   pop  esi
//   add  esp, 8
//   ret                         ; __cdecl/thiscall, no stack args → RET (0)
//
//   Layout inferred:
...
//     +0x17   CALL rel32 → FUN_00421c70 (0x00421c70)
//     +0x29   CALL rel32 → FUN_0040df70 (0x0040df70)
//
// Reconstruction strategy — naked-asm byte passthrough (same as siblings
// FUN_00406fa0 / FUN_00401460): the two CALL rel32 displacements are
// re-emitted as the orig binary's already-resolved bytes; tools/compare.py
// masks the rel32 callsites, so the .obj .text matches byte-for-byte.

extern "C" __declspec(naked) void FUN_00421e10() {
    __asm {
        ...
        _emit 0xce
        _emit 0xe8              // CALL rel32 → 0x00421c70
        _emit 0x44
        _emit 0xfe
        _emit 0xff
        _emit 0xff
