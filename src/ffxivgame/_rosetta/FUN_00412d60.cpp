...
//
// Structurally identical to FUN_00411fa0 (same size, same logic, same
// spinlock shape); differs only in three struct-offset bytes:
//   head at this+0x38 (vs 0x48), sentinel at this+0x34 (vs 0x44),
//   and container field at result+0x14 (vs result+0x0c).
//
