...
//
// FUNCTION: ffxivgame 0x413aa0 — member-vtable tail-jmp via EDX (member offset 0x18, slot 0x10)
//
// Asm: 8b 49 18 8b 01 8b 50 10 ff e2
//
//   8b 49 18   mov  ecx, [ecx + 0x18]   ; load member pointer at this+0x18
//   8b 01      mov  eax, [ecx]          ; load vtable pointer
//   8b 50 10   mov  edx, [eax + 0x10]   ; load vtable slot 0x10
