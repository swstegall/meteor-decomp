...
//
// FUNCTION: ffxivgame 0x00423110 — __thiscall dispatch method (52 bytes)
//
...
//        CALL FUN_00423c60          -> this->field4->method(arg1,arg2,arg3)
//     2. TEST AL,AL ; JNZ done      -> if non-zero, skip
//     3. MOV ECX,[ESI] ; MOV EAX,[ECX] ; MOV EDX,[EAX+0x18]
//        PUSH EBX,EDI,EBP (arg2,arg3,arg1 -> right-to-left = (arg1,arg3,arg2))
//        CALL EDX                   -> this->field0->vtable[6](arg1,arg3,arg2)
//
//   Structurally identical to FUN_00423150 (RVA 0x00023150); the two
//   differences are the call target (FUN_00423c60 vs FUN_00423770) and the
//   vtable slot offset (0x18 = slot 6, vs 0x1c = slot 7).
//
...
//   FUN_00423c60 and the indirect CALL EDX are both masked by compare.py.

extern "C" int FUN_00423c60();   // __thiscall at RVA 0x00023c60

extern "C" __declspec(naked) void FUN_00423110() {
    __asm {
        push    ebx
