...
//
// FUNCTION: ffxivgame 0x0001c300 — __cdecl 1-byte-arg wrapper; loads global
//           object pointer into ECX and forwards to FUN_004236e0 (23 B / 0x17)
//
// Asm (23 bytes @ orig RVA 0x0001c300):
...
//   68 b9 00 00 00          PUSH  0xb9                       ; push 1st arg (185)
//   e8 ca 73 00 00          CALL  FUN_004236e0               ; rel32 reloc
//   c3                      RET
//
...
// from the global DWORD at 0x0132987c, first arg is the constant 0xb9, second
// arg is the byte parameter zero-extended to a DWORD.
//
...
extern "C" __declspec(naked) void FUN_0041c300() {
    __asm {
